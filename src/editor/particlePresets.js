...
export const PARTICLE_PRESETS = {
  ...
  Snow: {
    nodes: [
      ...
      { id: "fall", type: "vec3", props: { value: [0, -0.9, 0] }, position: { x: -60, y: 230 } },
      { id: "windN", type: "wind", props: { direction: [1, 0, 0.3], strength: 0.4, gustiness: 1, gustFrequency: 0.3 }, position: { x: -60, y: 400 } },
      { id: "sway", type: "turbulence", props: { frequency: 0.35, strength: 0.4, speed: 0.3 }, position: { x: -60, y: 570 } },
      { id: "drag", type: "drag", props: { amount: 0.4 }, position: { x: -60, y: 740 } },
      { id: "f1", type: "add", props: {}, position: { x: 170, y: 470 } },
      { id: "f2", type: "add", props: {}, position: { x: 170, y: 640 } },
