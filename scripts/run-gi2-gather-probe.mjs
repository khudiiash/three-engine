...
// ── the CPU reference ────────────────────────────────────────────────────────
//
// ⚠ §19 3.15 MOVED IT TO scripts/lib/gi2Reference.mjs, VERBATIM. The corridor
// probe needs the same tracer over a different room, and two copies of a
// reference are two descriptions of the truth. Imported, not re-derived.
import { lum, makeReference, mulberry32 } from "./lib/gi2Reference.mjs";
